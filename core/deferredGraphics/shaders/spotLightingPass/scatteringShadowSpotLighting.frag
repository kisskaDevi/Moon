...
void main()
{
    ...
    outColor = ao * calcLight(position, normal, baseColorTexture, eyePosition, shadowMap, lightTexture, true);
    ...
    outBlur = LightScattering(50, light.view, light.proj, light.projView, light.position, light.color, projview, eyePosition, glPosition, lightTexture, shadowMap, depthMap, lightDropFactor, type);
}
