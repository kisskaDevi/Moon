...
void main()
{
    ...
    outBlur += LightScattering(50, light.view, light.proj, light.projView, light.position, lightColor, projview, eyePosition, glPosition, lightTexture, shadowMap, depthMap, type);
