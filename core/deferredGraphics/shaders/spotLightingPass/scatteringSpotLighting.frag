...
void main()
{
    ...
    outBlur = LightScattering(50, light.view, light.proj, light.projView, light.position, light.color, projview, eyePosition, glPosition, lightTexture, depthMap, lightDropFactor, type);
}
