...
void SSLRGraphics::createAttachments(uint32_t attachmentsCount, attachments* pAttachments)
{
    ...
    VkSamplerCreateInfo ssaoSamplerInfo{};
        ...
        ssaoSamplerInfo.maxAnisotropy = 1.0f;
        ssaoSamplerInfo.borderColor = VK_BORDER_COLOR_INT_OPAQUE_BLACK;
        ssaoSamplerInfo.unnormalizedCoordinates = VK_FALSE;
        ssaoSamplerInfo.compareEnable = VK_FALSE;
        ssaoSamplerInfo.compareOp = VK_COMPARE_OP_ALWAYS;
    ...
    vkCreateSampler(*device, &ssaoSamplerInfo, nullptr, &pAttachments->sampler);
}
