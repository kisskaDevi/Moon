...
void deferredGraphics::bloomExtension::createPipeline(VkDevice* device, imageInfo* pInfo, VkRenderPass* pRenderPass)
{
    ...
    auto vertShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\bloom\\vertBloom.spv");
    auto fragShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\bloom\\fragBloom.spv");
...
void deferredGraphics::oneColorExtension::createPipeline(VkDevice* device, imageInfo* pInfo, VkRenderPass* pRenderPass)
{
    ...
    auto vertShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\oneColor\\oneColorVert.spv");   //считываем шейдеры
    auto fragShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\oneColor\\oneColorFrag.spv");
...
void deferredGraphics::StencilExtension::createFirstPipeline(VkDevice* device, imageInfo* pInfo, VkRenderPass* pRenderPass)
{
    ...
    auto vertShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\stencil\\firststencilvert.spv");
    auto fragShaderCode = readFile(ExternalPath + "core\\graphics\\deferredGraphics\\shaders\\stencil\\firststencilfrag.spv");
