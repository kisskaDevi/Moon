...
C:/VulkanSDK/1.2.170.0/Bin32/glslc.exe postProcessing/postProcessingShader.vert -o postProcessing/postProcessingVert.spv
C:/VulkanSDK/1.2.170.0/Bin32/glslc.exe postProcessing/postProcessingShader.frag -o postProcessing/postProcessingFrag.spv
C:/VulkanSDK/1.2.170.0/Bin32/glslc.exe bloomSprite/bloomSprite.vert -o bloomSprite/vertBloomSprite.spv
