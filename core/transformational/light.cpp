...
light<spotLight>::light(VkApplication *app, uint32_t imageCount, uint32_t type)
    : app(app), type(type), imageCount(imageCount)
{
...
void light<spotLight>::Shadow::Destroy(VkApplication  *app)
{
...
void light<spotLight>::Shadow::createDescriptorSetLayout(VkApplication *app)
{
