...
//    uint32_t blitting = 1;
//    for(uint32_t blitImage = 0; blitImage<PostProcessing.getBlitAttachments().size(); blitImage++)
//    {
...
//            barrier.image = PostProcessing.getBlitAttachments()[blitImage].image[i];
...
//        vkCmdPipelineBarrier(commandBuffers[number][i],sourceStage, destinationStage,0,0, nullptr,0,nullptr,1,&barrier);
...
//            barrier.srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
//            barrier.dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
//            barrier.image = PostProcessing.getDownAttachments()[blitImage].image[i];
//            barrier.subresourceRange.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            barrier.subresourceRange.baseMipLevel = 0;
//            barrier.subresourceRange.levelCount = VK_REMAINING_MIP_LEVELS;
//            barrier.subresourceRange.baseArrayLayer = 0;
...
//            blit.srcOffsets[1] = {static_cast<int32_t>(PostProcessing.SwapChainImageExtent().width),static_cast<int32_t>(PostProcessing.SwapChainImageExtent().height),1};
//            blit.srcSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            blit.srcSubresource.mipLevel = 0;
//            blit.srcSubresource.baseArrayLayer = 0;
//            blit.srcSubresource.layerCount = 1;
//            blit.dstOffsets[0] = {0, 0, 0};
//            blit.dstOffsets[1] = {static_cast<int32_t>(PostProcessing.SwapChainImageExtent().width/blitting),static_cast<int32_t>(PostProcessing.SwapChainImageExtent().height/blitting),1};
//            blit.dstSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            blit.dstSubresource.mipLevel = 0;
//            blit.dstSubresource.baseArrayLayer = 0;
//            blit.dstSubresource.layerCount = 1;
//            vkCmdBlitImage(commandBuffers[number][i],
//                            Graphics.getAttachments()[1].image[i], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
//                            PostProcessing.getDownAttachments()[blitImage].image[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
//                            1, &blit, VK_FILTER_LINEAR);
//        }else{
//            blit.srcOffsets[0] = {0, 0, 0};
//            blit.srcOffsets[1] = {static_cast<int32_t>(PostProcessing.SwapChainImageExtent().width/blitting*2),static_cast<int32_t>(PostProcessing.SwapChainImageExtent().height/blitting*2),1};
//            blit.srcSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            blit.srcSubresource.mipLevel = 0;
//            blit.srcSubresource.baseArrayLayer = 0;
//            blit.srcSubresource.layerCount = 1;
...
//            blit.dstSubresource.layerCount = 1;
//            vkCmdBlitImage(commandBuffers[number][i],
//                            PostProcessing.getDownAttachments()[blitImage-1].image[i], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
//                            PostProcessing.getDownAttachments()[blitImage].image[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
//                            1, &blit, VK_FILTER_LINEAR);
//        }
...
//            blit.srcOffsets[0] = {0, 0, 0};
//            blit.srcOffsets[1] = {static_cast<int32_t>(PostProcessing.SwapChainImageExtent().width/blitting),static_cast<int32_t>(PostProcessing.SwapChainImageExtent().height/blitting),1};
//            blit.srcSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            blit.srcSubresource.mipLevel = 0;
//            blit.srcSubresource.baseArrayLayer = 0;
//            blit.srcSubresource.layerCount = 1;
//            blit.dstOffsets[0] = {0, 0, 0};
//            blit.dstOffsets[1] = {static_cast<int32_t>(PostProcessing.SwapChainImageExtent().width),static_cast<int32_t>(PostProcessing.SwapChainImageExtent().height),1};
//            blit.dstSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
//            blit.dstSubresource.mipLevel = 0;
//            blit.dstSubresource.baseArrayLayer = 0;
//            blit.dstSubresource.layerCount = 1;
//        vkCmdBlitImage(commandBuffers[number][i],
//                        PostProcessing.getDownAttachments()[blitImage].image[i], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
//                        PostProcessing.getBlitAttachments()[blitImage].image[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
//                        1, &blit, VK_FILTER_LINEAR);
...
//    }
            ...
            VkImageMemoryBarrier barrier{};
                ...
                barrier.srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
                barrier.dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
                barrier.image = PostProcessing.getBlitAttachments()[0].image[i];
                barrier.subresourceRange.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
                barrier.subresourceRange.baseMipLevel = 0;
                barrier.subresourceRange.levelCount = VK_REMAINING_MIP_LEVELS;
                barrier.subresourceRange.baseArrayLayer = 0;
            ...
            vkCmdBlitImage(commandBuffers[number][i],
                            Graphics.getAttachments()[1].image[i], VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
                            PostProcessing.getBlitAttachments()[0].image[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                            1, &blit, VK_FILTER_LINEAR);

        generateMipmaps(&commandBuffers[number][i],PostProcessing.getBlitAttachments()[0].image[i],PostProcessing.SwapChainImageExtent().width,PostProcessing.SwapChainImageExtent().height,8);
