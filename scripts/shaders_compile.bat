...
python3 %dir_path%/shaders_compile.py -d %dir_path%/../core/workflows/shaders -o %dir_path%/../core/workflows/spv -c %dir_path%/../dependences/libs/vulkan_tools/glslc.exe
